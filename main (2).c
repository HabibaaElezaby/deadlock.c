...
void *function2( ) {
     printf("Thread TWO request second_mutex\n");
     pthread_mutex_lock(&second_mutex);
     printf("Thread TWO acquired second_mutex\n");
     sleep(1);
     printf("Thread TWO request first_mutex\n");
